...
examples. `2026-08-25-SAFETY.md` defines the enforced safe/unsafe boundary; this guide
...
4. Prefer vetted folds, maps, filters, generators, and list operations over
   custom recursion. See `2026-08-25-SAFETY.md` for the enforced recursion rules.
