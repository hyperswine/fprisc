...
split did not implement one. (Since done: the `posix` system, docs/2026-09-19-PROFILES.md, which also says
how it differs from `qos-portable`.) Likewise, the proposed QOS/Base relationship is not
a completed Base conformance claim.

See [2026-09-16-PLATFORM.md](2026-09-16-PLATFORM.md) and [2026-09-16-DOCUMENTATION.md](2026-09-16-DOCUMENTATION.md). Their
...
See [2026-09-18-MACHINE-PRIMITIVES.md](2026-09-18-MACHINE-PRIMITIVES.md).
