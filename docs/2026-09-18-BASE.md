...
machine it runs on: the `posix` system of docs/2026-09-19-PROFILES.md, for a program
...
[2026-09-20-STD.md](2026-09-20-STD.md).
...
driver.c` links the C that implements them (docs/2026-09-19-C-REDUCTION.md). A program
...
- `machine/unix/main.c` boots as crt0.S would: `fpr_rt_init`, one pthread per
