...
See [PROFILES.md](PROFILES.md) for the implemented terminology and compatibility
...
See [TRANSACTION.md](TRANSACTION.md) for the actual contract and its exceptions.
...
[PRELIM_BASE_LIBRARY_DESIGN.md](PRELIM_BASE_LIBRARY_DESIGN.md). That inventory is
