...
Related policy: [PLATFORM.md](PLATFORM.md). This proposal refines candidates; it
...
Retain the execution distinctions in the current [transaction model](TRANSACTION.md):
