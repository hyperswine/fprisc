...
2026-09-12-V2.md workstream 3 in one page each for: what exists, what the tiers
...
The platform membership policy is in [2026-09-16-PLATFORM.md](2026-09-16-PLATFORM.md): mandatory
...
| `mods/bbspi`, `matrixkpd`, `oled`, `ttp229` | 42/45/45/34 | 0-1 | 0 | **`lib/drivers/`** | device drivers; the driver contract (`docs/2026-09-19-HAL.md`) is where they get their shape |
...
1. a section in `docs/2026-09-20-STD.md` (does not exist yet -- 2.0-alpha.1
   creates it),
...
Inside 2026-09-12-V2.md's four-phase plan:

**2.0-alpha.1 (paper).**  Decide strings: bytes or code points
(SEMANTICS §3) -- blocks every signature in `std/str`.  Write
`docs/2026-09-20-STD.md` with a section per module as it will be, including the
...
20 commented `unsafe`s; `docs/2026-09-20-STD.md` complete; check-all green on
...
- It does not unify the FP-RISC and Sol *spellings* beyond the shared
  surface in §3.  `docs/2026-09-02-API-REVIEW.md`'s D1-D5 are real decisions but
