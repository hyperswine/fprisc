...
RT_POSIX = $(MACHINE)/posix/main.c $(MACHINE)/posix/hal.c $(MACHINE)/posix/park.c $(MACHINE)/posix/host.c $(MACHINE)/posix/base.c $(MACHINE)/posix/base_file.c $(MACHINE)/posix/os_fs.c $(MACHINE)/posix/os_clock.c $(MACHINE)/posix/os_io.c $(MACHINE)/posix/os_proc.c $(MACHINE)/posix/os_watch.c $(MACHINE)/posix/os_net.c $(MACHINE)/posix/os_term.c $(POSIXCTX)
