...
builtinEnv =
  M.fromList
    [ ("Word.fromInt", mono (TFn tInt (TC "Word"))),
      ("Word.toInt", mono (TFn (TC "Word") tInt)),
      ("Word.bits", mono (TFn tUnit tInt)),
      ("Word.and", mono (TFn (TC "Word") (TFn (TC "Word") (TC "Word")))),
      ("Word.or", mono (TFn (TC "Word") (TFn (TC "Word") (TC "Word")))),
      ("Word.xor", mono (TFn (TC "Word") (TFn (TC "Word") (TC "Word")))),
      ("Word.add", mono (TFn (TC "Word") (TFn (TC "Word") (TC "Word")))),
      ("Word.sub", mono (TFn (TC "Word") (TFn (TC "Word") (TC "Word")))),
      ("Word.not", mono (TFn (TC "Word") (TC "Word"))),
      ("Word.shl", mono (TFn (TC "Word") (TFn tInt (TC "Word")))),
      ("Word.shr", mono (TFn (TC "Word") (TFn tInt (TC "Word")))),
      ("Word.mask", mono (TFn tInt (TFn tInt (TC "Word")))),
      ("Word.eq", mono (TFn (TC "Word") (TFn (TC "Word") tBool))),
      ("Addr.fromWord", mono (TFn (TC "Word") (TC "Addr"))),
      ("Addr.toWord", mono (TFn (TC "Addr") (TC "Word"))),
      ...
      ("Mem.write16", mono (TFn (TC "Addr") (TFn tInt tUnit))),
      ("Mem.read32", mono (TFn (TC "Addr") (TC "Word"))),
      ("Mem.write32", mono (TFn (TC "Addr") (TFn (TC "Word") tUnit))),
      ("Mem.readWord", mono (TFn (TC "Addr") (TC "Word"))),
      ("Mem.writeWord", mono (TFn (TC "Addr") (TFn (TC "Word") tUnit))),
      ("Mem.liveAllocations", mono (TFn tUnit tInt)),
      ("Mem.alloc", mono (TFn tInt (TC "Addr"))),
      ("Mem.realloc", mono (TFn (TC "Addr") (TFn tInt (TC "Addr")))),
      ("Mem.free", mono (TFn (TC "Addr") tUnit)),
      ("Word.bitSet", mono (TFn (TC "Word") (TFn tInt (TC "Word")))),
      ("Word.bitClear", mono (TFn (TC "Word") (TFn tInt (TC "Word")))),
      ("Word.bitTest", mono (TFn (TC "Word") (TFn tInt tBool))),
      ("CPU.csrRead", mono (TFn tInt (TC "Word"))),
      ("CPU.csrWrite", mono (TFn tInt (TFn (TC "Word") tUnit))),
      ("CPU.irqSave", mono (TFn tUnit tInt)),
      ("CPU.irqRestore", mono (TFn tInt tUnit)),
      ("CPU.irqEnable", mono (TFn tUnit tUnit)),
      ("CPU.wait", mono (TFn tUnit tUnit)),
      ("CPU.instructionFence", mono (TFn tUnit tUnit)),
